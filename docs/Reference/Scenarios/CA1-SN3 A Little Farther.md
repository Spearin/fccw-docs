...
This time, they are to capture bridges in Wendlingen to prevent the Soviets from using them as they pull back from South of Stuttgart.  Grabbing these bridges will create an opportunity to block this retreat and trap them.
