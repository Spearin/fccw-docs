...
_D+22 | 11 Aug 1989, 0700hrs - 1100hrs [:smflag-us:](./Forces/United States.html) vs [:smflag-su:](./Forces/Soviet Union.html) @ [Aiterhofen](../Maps/Aiterhofen/Aiterhofen.html)_
...
d- Task engineer units to remove obstacles, clear minefields, and eliminate improved positions 8- Deploy bridging assets across terrain obstacles

\-       Use combat engineers and CEVs to support demolitions J- Coordinate with artillery units to emplace scatterable minefields U- Integrate engineer operations into broader tactical and operational planning
