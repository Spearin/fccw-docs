...
- ![](images/image084.png)Dialogs and Panels with this symbol in the lower right can be resized. Most have a minimum and maximum size.

- ![](images/image085.png)Dialogs and Panels with this symbol in the upper right can be collapsed to the title bar or expanded to full size. Useful if you want to see more of the screen.
...
!!! note
    ...
    If you have multiple monitors with different font scaling levels and drag dialogs to another screen with a different scale, the dialogs and other menu panels may not display correctly. This is something we are looking into and hope to correct in the future.
...
!!! note
    ...
    If you know the interface or want to jump to the how-to-do things portion of the manual, then head for Section 21 below on Issuing Orders.
