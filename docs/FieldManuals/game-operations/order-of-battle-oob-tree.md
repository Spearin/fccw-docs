...
![](images/image452.jpg)![](images/image454.jpg)An important function of the Spotlight Panel [***F10***] is the Order of Battle (OOB) Tree. The OOB tree provides a nested listing of all units and shows which units report to (are subordinate to) which headquarters as shown in the image below. This information is vital as command delays and resupply capability are tied to a unit’s distance from its local/primary headquarters.
