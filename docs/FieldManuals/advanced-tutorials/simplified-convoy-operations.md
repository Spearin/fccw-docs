...
![](images/image057.jpg) Like other tutorial scenarios select to play as the NATO Commander and for this first look set the Difficulty to Recruit to activate all the options to make things clear and easy for the first playthrough of this tutorial.
...
As shown in the screenshot below, the Tutorial: Convoy Operations is now displayed. ![](images/image059.jpg)
...
Then, Right-Click on the unit or cargo you want to load. ![](images/image075.jpg)
