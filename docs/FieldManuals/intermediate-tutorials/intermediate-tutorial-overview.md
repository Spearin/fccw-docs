...
- [**Engineering Operations**](#_Engineering_Operations) Learn how combat engineers can clear obstacles and mines, place demolitions to destroy bridges, and build defensive structures.

- [**Artillery Operations**](#_Tutorial_08_-) Learn how to call in and control artillery fire, supporting friendly units with powerful indirect fire.

- [**Air Support Operations**](#_Tutorial_09_-) Learn how to request and coordinate airstrikes, providing your ground forces with a critical edge in combat.

- [**NBC Operations**](#_NBC_Operations) Learn how to request and coordinate strikes with Nuclear and Chemical weapons.
