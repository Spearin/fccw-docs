---
icon: material/earth-box-plus
---
# :material-earth-box-plus: Map Construction: Introduction

!!! important
    The information in this tutorial will soon be obsolete. We have been developing a new workflow for map creation, and will update this guide once the new method is fully developed.
...
!!! note
    ...
    Some images in this manual are from other versions of the game\. While your maps and units may be different, all the information and how it is used and displayed will match the information seen in this manual\.