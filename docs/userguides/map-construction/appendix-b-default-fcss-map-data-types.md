...
**NOTE:** When scanning the hex and spotting different elevation colors, the most frequently occurring elevation color (the statistical ‘modus’ or ‘mode’) will be chosen as the hex’s elevation color.
