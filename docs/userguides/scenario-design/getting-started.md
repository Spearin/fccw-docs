...
- **Clear Scn File** – This button will wipe all the data for the currently selected scenario from the game so you can start fresh. **NOTE:** There is no undo from this, so be sure you want to dump everything.
