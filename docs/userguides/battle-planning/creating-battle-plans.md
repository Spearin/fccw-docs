...
!!! note
    ...
    Each “Mission Name” for a force must be unique.

!!! note

    When you create one or more Missions for each task force. You must create them in chronological order, as the ending point of one will become the starting point of another.
...
!!! note
    ...
    Make the changes to the Mission SOP, Duration, and Frontage first before selecting the “**Proceed**” button.
...
!!! note
    ...
    Order/Delay between artillery missions. For the US, it's 5 minutes. Add another minute for issuing the order and it’s 6 minutes between rounds landing from hex to hex for a firing unit.
...
!!! note
    ...
    As for Nukes, during the time of writing this FM Battle Planner, Nukes is a problem for the Developers. Hopefully, soon it will be working as planned.
...
!!! note
    ...
    “Area Fire” is for things like rocket barrages which can target multiple hexes. It will highlight when using Rocket units.
