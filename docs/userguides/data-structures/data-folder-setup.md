...
\* = Within each file on the National Tab, the Nationality entry under Game Defaults **MUST** match the “Your Country File Name” for the game to find and sort data files in the scenario editor.