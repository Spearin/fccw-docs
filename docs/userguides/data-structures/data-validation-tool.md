...
![](images/image041.png)![](images/image042.png)![](images/image043.png)
...
7. When your checks are complete, and all pages show green for errors you can click the Clear Errors button to remove the validation information.
...
![](images/image048.png)   As with all things Microsoft, in some cases the settings to run the Data Validation Program are such that it will not run due to access restrictions. The following steps should make it work. If not, you may need to look at other Windows settings that stop or block office macros and programs from running.
...
Also check the Macro Settings:![](images/image051.png)