...
- Open a transparent PNG symbol in Paint.NET.

- Copy and paste into the target layer.

- Use the Move Selected Pixels Tool to position.

- Option B – Draw Directly on Layer:

- Use the Line/Curve Tool, Ellipse Tool, or Rectangle Tool.

- Use appropriate color codes (e.g., Blue for friendly, red for enemy).
...
### Creatinga Graphic Using Paint.NET
