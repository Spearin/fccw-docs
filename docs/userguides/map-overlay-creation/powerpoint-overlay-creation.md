...
!!! note
    Once the blank slide is set, your workspace will be clean and ready for overlay construction. This ensures that all map elements, unit symbols, and tactical graphics can be added without obstruction from default text boxes or slide layouts.
...
!!! note
    If your overlay appears blurry, low-resolution DPI may be the cause.
...
- Or File → Export → Change File Type → PNG or JPEG
...
Figure. 4.2.4 – Select Ensure Fit
...
!!! note
    This section offers two methods for creating transparent slides—using a single slide for all graphics or creating multiple slides for each type (e.g., Maneuver, Fires, Engineers). The**preferred method is to use a single transparent slide** to keep the overlay process streamlined and easier to manage.
...
!!! note
    If you cannot find the specific symbol you need or want to create a custom unit symbol, refer to Appendix A5 – Guide to Searching Unit Symbols on Symbol.Army for detailed instructions on building your symbol.
...
!!! note
    Although the screenshot does not visually show the transparency, it *is* present. Transparent areas often appear as solid white or may blend into the background in static images. Still, when exported or used in your overlay, those areas will remain see-through as intended.
...
- Player 1 (NATO): briefingoverlaymap~side0.png

- Player 2: (Warsaw Pact) briefingoverlaymap~side1.png

- Threat Assessment Overlay:

- Player 1 (NATO): threatoverlaymap~side0.png

- Player 2 (Warsaw Pact): threatoverlaymap~side1.png