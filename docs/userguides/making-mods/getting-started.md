...
***FLASHPOINT CAMPAIGNS*** is a game of grand tactical warfare as it is a construction kit with sweeping capability to make almost any modern combat situation (Post WW2) you want. Before you dive headlong into a project, you should take some time to get your ducks (or other regionally specific animals) in a row. This chapter of the guide breaks down a few critical decisions and works on getting you ready to work on the modification (Mods) you want to make.
