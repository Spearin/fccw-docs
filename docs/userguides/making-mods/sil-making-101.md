...
some cases, certain hard to find units may require taking a real image and cleaning the background out and making some other adjustments to get a decent side view.
